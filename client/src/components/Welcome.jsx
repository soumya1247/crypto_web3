...
const Input = ({ placeholder, name, type, value, handleChange }) => (
  <input
    ...
    className="my-2 w-full rounded-sm p-2 outline-none bg-[#000036] text-white border-none text-sm white-glassmorphism"
  />
);
    ...
    <div className='flex w-full justify-center items-center'>
      <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          <h1 className='text-3xl sm:text-5xl text-white text-gradient py-1'>Send Crypto<br />
            Across the World
          </h1>
          <p className='text-left mt-5 text-white font-white md:w-9/12 w-11/12 text-base'>
            Explore and sell cyptocurrencies easily on CryptoArena
          </p>
          {!connectedAccount && (
            <button
              type="button"
